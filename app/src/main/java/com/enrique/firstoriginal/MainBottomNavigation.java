...
import com.enrique.firstoriginal.databinding.ActivityMainBottomNavigationBinding;
import com.enrique.firstoriginal.ui.main.SectionsPagerAdapter;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.likes:
                        ...
                        Toast.makeText(MainBottomNavigation.this, "Likes clicked.", Toast.LENGTH_SHORT).show();
                        removeBadge(mybottomNavView,item.getItemId());
                        viewPager.setCurrentItem(0);
                        break;
                    case R.id.add:
                        item.setChecked(true);
                        Toast.makeText(MainBottomNavigation.this, "Add clicked.", Toast.LENGTH_SHORT).show();
                        removeBadge(mybottomNavView,item.getItemId());
